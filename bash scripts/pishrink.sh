...
#dit script staat in de /usr/local/bin folder en zal een nieuwe machine id genereren
newMachineId.sh
sleep 5
raspi_config_expand
...
echo "Shrunk $img from $beforesize to $aftersize"/bin/bash /home/$USER/newMachineId.sh
sleep 5
